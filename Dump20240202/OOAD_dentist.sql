...
CREATE TABLE `dentist` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
  CONSTRAINT `dentist_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `Users` (`id`)
...
INSERT INTO `dentist` VALUES (20,1,NULL,NULL),(21,3,NULL,NULL),(22,4,NULL,NULL),(23,5,NULL,NULL),(24,9,NULL,NULL);
